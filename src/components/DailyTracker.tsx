...
import { Plus, Smile, Meh, Frown, Zap, Battery, Calendar as CalendarIcon, Flame, Beef, Droplet, Sparkles, ArrowDownUp, SortDesc } from "lucide-react";
                    ...
                    <div className="flex flex-col gap-2">
                      {sortedLoggedFoods.map(({food, quantity}) => (
                        <FoodCard
                            ...
                            quantity={quantity}
                            isPending={isPending}
                            onQuantityChange={(food, change) => handleQuantityChange(food, change)}
